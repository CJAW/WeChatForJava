...
import com.wechat.checkQQemotion.CheckQQEmotion;
import com.wechat.emoji.CharEmjio;
...
public class WeChatService {
	...
	public static String process(HttpServletRequest request){
		...
		if (msgType.equals(REQ_MESSAGE_TYPE_TEXT)) {
			...
			//使用qq表情
			String emotion = message.get("Content");
			
			if(CheckQQEmotion.isQqFace(emotion)){
				
				respMessage = emotion;
			}
			
			//使用emjio表情
			respMessage = "请使用菜单!"+CharEmjio.charEmjio(0x1F478)+"      "+CharEmjio.charEmjio(0xE445)+"\n";
